...
public class NaturalistFabric implements ModInitializer {
    ...
    void addSpawns() {
        ...
        addMobSpawn(NaturalistTags.Biomes.HAS_FINCH, MobCategory.CREATURE, NaturalistEntityTypes.FINCH.get(), config.finchSpawnWeight, 1, 4);
        addMobSpawn(NaturalistTags.Biomes.HAS_SPARROW, MobCategory.CREATURE, NaturalistEntityTypes.SPARROW.get(), config.sparrowSpawnWeight, 1, 4);
