...
public class ElephantRenderer extends GeoEntityRenderer<Elephant> {
    ...
    @Override
    public void render(Elephant entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        if (entity.isBaby()) {
   ...
   public RenderType getRenderType(Elephant entity, float partialTicks, PoseStack stack, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
