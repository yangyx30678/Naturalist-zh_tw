...
public class LionRenderer extends GeoEntityRenderer<Lion> {
   ...
   public RenderType getRenderType(Lion entity, float partialTicks, PoseStack stack, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
