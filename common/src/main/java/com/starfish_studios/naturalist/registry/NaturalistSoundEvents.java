...
public class NaturalistSoundEvents {
    ...
    public static final Supplier<SoundEvent> TORTOISE_HIDE = CommonPlatformHelper.registerSoundEvent("tortoise_hide", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Naturalist.MOD_ID, "entity.tortoise.hide")));
    public static final Supplier<SoundEvent> TORTOISE_THUD = CommonPlatformHelper.registerSoundEvent("tortoise_thud", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Naturalist.MOD_ID, "entity.tortoise.thud")));
    public static final Supplier<SoundEvent> TORTOISE_HURT = CommonPlatformHelper.registerSoundEvent("tortoise_hurt", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Naturalist.MOD_ID, "entity.tortoise.hurt")));
    public static final Supplier<SoundEvent> TORTOISE_DEATH = CommonPlatformHelper.registerSoundEvent("tortoise_death", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Naturalist.MOD_ID, "entity.tortoise.death")));
   ...
   /*
    ...
    public static final Supplier<SoundEvent> OSTRICH_AMBIENT = CommonPlatformHelper.registerSoundEvent("ostrich_ambient", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Naturalist.MOD_ID, "entity.ostrich.ambient")));
    public static final Supplier<SoundEvent> OSTRICH_HURT = CommonPlatformHelper.registerSoundEvent("ostrich_hurt", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Naturalist.MOD_ID, "entity.ostrich.hurt")));
    public static final Supplier<SoundEvent> OSTRICH_DEATH = CommonPlatformHelper.registerSoundEvent("ostrich_death", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Naturalist.MOD_ID, "entity.ostrich.death")));
    // Ostrich Eggs
    public static final Supplier<SoundEvent> OSTRICH_EGG_BREAK = CommonPlatformHelper.registerSoundEvent("ostrich_egg_break", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Naturalist.MOD_ID, "entity.ostrich.egg_break")));
